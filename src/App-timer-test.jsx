  ...
  return (
    <ThemeProvider theme={simpleTheme}>
      ...
      <Box sx={{ 
        ...
        <Box sx={{ border: '2px dashed #FF6B9D', p: 3, borderRadius: 2, bgcolor: 'rgba(255,255,255,0.8)' }}>
          <Typography variant="h6" gutterBottom>EventTimer Component Test:</Typography>
          <EventTimer />
        </Box>
      </Box>
    </ThemeProvider>
